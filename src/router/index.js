...
const routes = [
  ...
  },
  {
    ...
    name: 'TopFrance',
    component: movieListComp,
    props:{ URL : 'https://api.themoviedb.org/3/discover/movie?api_key=1bb6a53d24541d6fce0843f7b08de85d&language=fr-FR&include_adult=false&include_video=true&page=1&primary_release_date.gte=1980&with_original_language=fr&with_watch_monetization_types=flatrate'}
  },
  {
    path: '/TopUsa',
    name: 'TopUsa',
    component: movieListComp,
    props:{ URL : 'https://api.themoviedb.org/3/discover/movie?api_key=1bb6a53d24541d6fce0843f7b08de85d&language=en-US&include_adult=false&include_video=true&page=1&with_watch_monetization_types=flatrate'}
  },
  {
    path: '/TopAnnee',
    name: 'TopAnnee',
